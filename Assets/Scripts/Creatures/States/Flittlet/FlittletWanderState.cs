...
public class FlittletWanderState : BaseState
{
    ...
    public FlittletWanderState(StateMachine stateMachine, NavMeshAgent creatureAgent, Creatures creature, float wanderRadius) : base(stateMachine)
    {
